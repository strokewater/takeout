...
<div style="margin: 0 auto; padding-bottom: 0%; padding-top: 7.5%; width: 380px;">
    <div class="panel panel-color panel-danger panel-pages panel-shadow">
        <div class="panel-default" >
            ...
            <h3 class="text-center m-t-10" style="color:black;"> 管理员登录页面</h3>
        </div>
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" method="post" id="loginForm" >
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        <button class="btn btn-danger btn-lg btn-rounded btn-block w-lg waves-effect waves-light" style="background-color:#3385FF;box-shadow: 0px 0px 4px #3385FF;border:1px solid #3385FF;" type="button" onclick="login()">登&nbsp;录
                        </button>
                    </div>
                </div>
            </form>
